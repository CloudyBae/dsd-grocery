      ...
      {ingredientListData.map((ingredient) => ( 
        <View key={ingredient.id} style={styles.itemContainer}>
          <View style={styles.firstSection}>
            ...
            />
            <Image
              source={{ uri: ingredient.image || 'https://placeholder.pics/svg/300/DEDEDE/555555/placeholder' }}
              style={styles.productImg}
              resizeMode='cover'
            />
          </View>
          <View style={styles.textSection}>
            <Text style={styles.headingText}>{ingredient.name}</Text>
            <Text style={styles.amountText}>{ingredient.quantity} quantity</Text>
